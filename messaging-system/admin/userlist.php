	...
	<table width="100%" class="table table-striped table-bordered table-hover" id="userList">
		...
		<?php
			...
			<tr>
				...
				<td> 
					<button type="button" class="btn btn-warning edituser" value="<?php echo $row['userid']; ?>"> Edit</button> || 
					<button type="button" class="btn btn-danger deleteuser" value="<?php echo $row['userid']; ?>"> Delete</button>
				</td>
			</tr>
			<?php
			}
