		<div class="col-lg-12">
            <div class="panel panel-default" style="height:50px;">
				<span style="font-size:18px; margin-left:10px; position:relative; top:13px;"><strong>Room: <?php echo $chatrow['chat_name']; ?></strong></span>
			...
			<div>
				<div class="panel panel-default" style="height: 400px;">
					<div style="height:10px;"></div>
					<span style="margin-left:10px;">Welcome To The Chatroom, Users.</span><br>
					<span style="font-size:10px; margin-left:10px;"><i>Please avoid using offensive language and hate speech to maintain a positive and respectful community. Violating this guideline may result in account restrictions or termination. Thank you for your cooperation.</i></span>
					<div style="height:10px;"></div>
